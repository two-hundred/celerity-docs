...
1. `string` - A valid reference representing the json string to extract values from.
...
1. `string` - A valid reference representing the json string to decode.
...
1. `string` - A valid reference representing the string, array, or mapping to get the length of.
...
1. `string` - A valid reference representing the string to get the substring from.
...
1. `string` - A valid reference representing an input string that contains a substring that needs replacing.
...
1. `string` - A valid reference representing the string to trim.
...
1. `string` - A valid reference representing the string to remove the prefix from.
...
1. `string` - A valid reference representing the string to remove the suffix from.
