...
function DocVersionBannerEnabled({
  ...
  const customPluginContent = (customFields as CustomFields).customPluginContent[pluginId];
  const title = customPluginContent?.title ?? siteTitle;
  ...
  return (
    <div
      ...
      role="alert">
      <div>
        <BannerLabel siteTitle={title} versionMetadata={versionMetadata} />
      </div>
